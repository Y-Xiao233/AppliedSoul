...
public class SoulCollectorMenu extends UpgradeableMenu<SoulCollectorHost> {
    public static final MenuType<SoulCollectorMenu> TYPE = MenuTypeBuilder.create(SoulCollectorMenu::new, SoulCollectorHost.class).buildUnregistered(AppliedSoul.makeId("soul_collector"));
